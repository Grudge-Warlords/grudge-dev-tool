      ...
      <div className="mx-auto max-w-[1500px] space-y-4">
        ...
        <div className="grid gap-4 xl:grid-cols-[minmax(440px,0.9fr)_minmax(520px,1.1fr)]">
          ...
          <section className={`${card} flex min-h-[700px] flex-col overflow-hidden`}>
            ...
            {job?.conceptImagePath && conceptRejected && <div className="border-b border-line p-3"><img className="max-h-64 w-full rounded object-contain" src={`local://${encodeURIComponent(job.conceptImagePath)}`} alt="Preserved local generation concept" /><div className="mt-2 rounded border border-red-500/30 bg-red-500/10 p-3 text-xs text-red-200"><b>Concept-quality failure.</b> The generated object touched the crop/edge boundary. This image is retained for review and no geometry model was loaded. Retry is a deliberate concept-only run with a new seed.</div></div>}
