  ...
  async function setAllFileDefaults() {
    ...
    try {
      ...
      toast.success(`Registered ${r.registered} file types`, {
        description: "3D opens the ThreePipe editor; images/audio/video open Elite. Vue ThreeFlow is an explicit action. Never Forge by default.",
      });
    ...
    <div>
      ...
      <div className="card">
        ...
        <p className="muted text-sm mb-3">
          ...
          asset types (3D, images, audio, video, text, PDF). Double-click opens the{" "}
          <strong className="text-gold">Elite viewer</strong> with production loaders.
          Vue ThreeFlow / ThreePipe are explicit actions — never Forge by default.
        </p>
        <div className="flex flex-wrap gap-2 items-center mb-2">
          {[
            ...
            <img
              ...
              width={28}
              height={28}
              title={src.replace("https://assets.grudge-studio.com", "assets")}
              style={{
                borderRadius: 4,
