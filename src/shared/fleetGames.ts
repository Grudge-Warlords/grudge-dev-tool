...
export const FLEET_GAMES: FleetGame[] = [
  ...
  },
  {
    ...
    description: "Garage + Grudge City street racing — drive.grudge-studio.com.",
  ...
  },
  {
    ...
    description: "Rec0deD:88 portal — Avernus Arena at /avernus-arena, fleet hub.",
  ...
  },
  {
    ...
    description: "grudge6 combat pit — RoleControls, FOLLOW TPS, Tab targeting.",
    url: "https://grudge-studio.com/avernus-arena",
    repo: "The-ENGINE",
    engine: "Three.js + Cannon-ES",
    status: "live",
    category: "action",
    topics: ["action", "arena", "grudge6"],
    thumbnail: THUMB("The-ENGINE"),
  },
  {
    id: "grudgecontrol",
