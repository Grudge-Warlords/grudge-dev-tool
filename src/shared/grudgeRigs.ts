...
export const GRUDGE_SKELETON_FINGERPRINTS: SkeletonFingerprint[] = [
  ...
  /** Primary target for Skeleton Studio placement + retarget library */
  { name: "mixamo-25-nofingers", label: "Mixamo 25 (no fingers)", jointCounts: [25, 24, 26, 22, 23], requiredBones: ["mixamorig:Hips", "mixamorig:LeftHand", "Hips", "LeftHand"] },
