...
export const DOCS_CATALOG: DocEntry[] = [
  {
    ...
    file: "index.md",
    pagesPath: "/",
    description: "Product overview, install, Grudge ID + puter-space, ONE TRUTH first connection.",
    group: "start",
    primary: true,
  },
  {
    ...
    description: "Install Grudge Dev Tool, Grudge ID sign-in, Assets → Forge loop.",
    group: "start",
    primary: true,
  },
  {
