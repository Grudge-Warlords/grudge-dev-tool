...
export const FLEET_ENDPOINTS: FleetEndpoint[] = [
  ...
  { id: "auth", label: "Grudge ID", url: FLEET_URLS.auth, role: "auth" },
  ...
  { id: "game-data", label: "Game data (Railway SSOT)", url: FLEET_URLS.gameData, role: "game-data" },
  { id: "ai", label: "Legion AI Hub", url: FLEET_URLS.ai, role: "ai" },
  { id: "forge", label: "Forge editor", url: FLEET_URLS.forge, role: "frontend" },
  { id: "warlords", label: "Warlords frontend", url: FLEET_URLS.warlords, role: "frontend" },
