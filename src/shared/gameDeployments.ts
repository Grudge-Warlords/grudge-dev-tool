...
export const GAME_DEPLOYMENT_DEFINITIONS: GameDeploymentDefinition[] = [
  ...
  {
    id: "multiverse",
    playModeId: "multiverse",
    displayName: "Grudge Multiverse",
    playUrl: "https://grudge-multiverse.vercel.app/#room1",
    assetPrefixes: [
      "models/maps/bermuda.glb",
      "models/grudge6/",
      "models/nature/",
      "models/vendors/",
    ],
    deployPrefix: "models/maps/",
    storeCategoryId: "warlords",
    deployKind: "vercel",
    status: "live",
    ...
    hasServer: true,
    bestPractices: [
      "SPA: grudge-multiverse.vercel.app — Open library card also launches here",
      "Dedicated Railway: grudge-multiverse-room-production — WS only /api/mv",
      "NOT Carrier, NOT gameopen-production, NOT metaverse.grudge-studio.com",
      "Map from R2: assets.grudge-studio.com/models/maps/bermuda.glb",
      "grudge6 CDN kits + local /ui/icons pack; Main Panel equip/skills/vendors",
      "VITE_MV_GAME_SERVER_URL → Multiverse Railway only",
    ],
    agenticDeployTask:
      "Deploy Multiverse SPA (npm run deploy) and room server (cd server && railway up). Smoke SPA + /api/health + WS path /api/mv. Confirm Open library Multiverse card URL.",
  ...
  },
  {
    ...
    displayName: "Velocity (Grudge City)",
    playUrl: "https://drive.grudge-studio.com",
    assetPrefixes: ["models/vehicles/", "environment/city/", "models/environment/"],
    deployPrefix: "models/vehicles/",
    storeCategoryId: "vehicles",
    deployKind: "vercel",
    status: "live",
    repo: "grudge-drive",
    bestPractices: [
      "SPA is arcade RacerLauncher / HubWorldGame — not Houston Cruise",
      "Canonical host drive.grudge-studio.com; Pages leftover 301s here",
      "Cars = catalog voxel GLBs; do not proxy grudge-velocity.pages.dev",
    ],
    agenticDeployTask:
      "Deploy Grudge City SPA to Vercel grudge-drive (npm run deploy:city). Smoke drive.grudge-studio.com lots + cars. Confirm Pages 301.",
    projectTemplate: "r3f-boilerplate",
  },
  {
    id: "grudge-arena",
  ...
  {
    id: "avernus-arena",
    playModeId: "avernus-arena",
    displayName: "Avernus Arena",
    playUrl: "https://grudge-studio.com/avernus-arena",
    assetPrefixes: [
      "asset-packs/toon-rts-characters/",
      "models/grudge6/",
      "prod/anims/",
    ],
    deployPrefix: "models/grudge6/",
    storeCategoryId: "characters",
    deployKind: "vercel",
    status: "live",
    repo: "The-ENGINE",
    bestPractices: [
      "Portal SPA The-ENGINE — vercel --prod --scope grudgenexus",
      "Play kit Toon {race}.glb + one mixer + RoleControls + GameCamera FOLLOW",
      "Baked Bip001 JSON from grudge-arena.grudge-studio.com/anims/baked",
    ],
    agenticDeployTask:
      "Deploy The-ENGINE to grudge-studio.com and smoke /avernus-arena: idle, WASD, Tab target, FOLLOW.",
    projectTemplate: "r3f-boilerplate",
  },
  {
    id: "dungeon-crawler",
