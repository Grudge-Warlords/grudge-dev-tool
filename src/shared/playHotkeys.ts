...
export const PLAY_HOTKEYS: PlayHotkeyDef[] = [
  ...
  { keys: "F", action: "Primary weapon skill (combatSkillKit)", group: "anim" },
  { keys: "1–4", action: "Skill slots / clip index", group: "anim" },
  { keys: "5–9", action: "Play clip index (one mixer)", group: "anim" },
