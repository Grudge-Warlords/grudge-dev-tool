...
const REQUIRED = [
  ...
  // Direct AI providers
  ["Groq API key",      "ai.groq",              false],
  ["OpenAI API key",    "ai.openai",            false],
  ["Gemini API key",    "ai.gemini",            false],
  ["Together API key",  "ai.together",          false],
  ["CF API token",      "cf-api-token",         false],
];
